      ...
      >
        ...
        <el-form-item label="使用组件" prop="components">
          <el-input
            ...
            type="textarea"
            :rows="3"
            placeholder="请输入使用的组件"
            clearable
          />
          <div class="form-tip">选或填该案例用的所有组件，用逗号分开，如："点击伸长组件、无线往返伸缩器"</div>
        </el-form-item>
        ...
        <el-form-item label="节日标签" prop="holiday">
          <el-select v-model="form.holiday" placeholder="请选择节日" style="width: 100%">
